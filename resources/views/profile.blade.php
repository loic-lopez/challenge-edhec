    ...
    <div class="page-wrapper">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h3 class="text-themecolor">@lang('general.profile_')</h3>
            </div>
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="/">@lang('general.home')</a></li>
                    <li class="breadcrumb-item active">@lang('general.profile_')</li>
                </ol>
            </div>
        </div>
        <!-- ============================================================== -->
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="m-t-30" style="text-align: center;">
                                <img src="/assets/images/users/user.svg" width="150" />
                                <h4 class="card-title m-t-10">@lang('general.city') @endlang {{ \Illuminate\Support\Facades\Auth::user()->city_name }}</h4>
                            </div>
                        </div>
                        <div>
                            <hr> </div>
                        <div class="card-body"> <small class="text-muted">@lang('general.email') </small>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="settings" role="tabpanel">
                                <div class="card-body">
                                    ...
                                    @endif
                                    <form class="form-horizontal form-material" action="/profile/password" method="post">
                                        {{ csrf_field() }}
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <button class="btn btn-success">@lang('general.update')</button>
                                            </div>
                                        </div>
                                    </form>
